      ...
      <div className="container-fluid bg-dark px-0">
                <div className="row gx-0 wow fadeIn" data-wow-delay="0.1s">
                    <div className="col-lg-3 bg-primary d-none d-lg-block">
                        <NavLink to="/dashboard" className="navbar-brand w-100 h-100 m-0 p-0 d-flex align-items-center justify-content-center">
                                ...
                                <div className="navbar-nav mr-auto py-0">
                                    ...
                                    <div className="nav-item dropdown">
                                        ...
                                        <div className="dropdown-menu rounded-0 m-0">
                                            ...
                                            <NavLink to="/blogadd" className="dropdown-item">Blog Post</NavLink>
